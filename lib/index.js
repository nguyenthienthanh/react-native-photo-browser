...
export default class PhotoBrowser extends React.Component {
  ...
  static propTypes = {
    ...
    fullScreenContainerListViewProps: PropTypes.object,
    gridContainerListViewProps: PropTypes.object,
  };
  ...
  constructor(props, context) {
    ...
    console.log('initIndex', initialIndex);
    this.state = {
  ...
  _onChangeImage(index, media) {
    this.props.onChangeImage(index, media);
  }
    ...
    if (mediaList.length > 0) {
        ...
        gridContainer = (
          ...
          >
            <GridContainer
              ...
              listViewProps={this.props.gridContainerListViewProps}
            />
          </Animated.View>
        );
      }
      ...
      fullScreenContainer = (
        <FullScreenContainer
          ...
          listViewProps={this.props.fullScreenContainerListViewProps}
        />
      );
    }
